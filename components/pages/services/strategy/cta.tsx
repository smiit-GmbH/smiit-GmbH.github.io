...
export default function StrategyCTA({ dict }: { dict: any }) {
  const cta = dict.servicesStrategy.cta
            ...
            <a href="#book" className="block w-full sm:w-auto">
              ...
              >
                ...
                <motion.span
                  ...
                  className="pointer-events-none absolute inset-y-0 -inset-x-2 -skew-x-12 bg-gradient-to-r from-transparent via-[#64748B]/22 to-transparent mix-blend-multiply"
                />
              </motion.div>
            </a>
          </motion.div>
